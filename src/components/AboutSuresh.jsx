...
export function PressArchiveFeature() {
  return (
    <section className="about-press-archive" aria-labelledby="press-archive-title">
      <header className="about-press-heading" data-reveal>
        <p className="eyebrow">From the press archive</p>
        <h2 id="press-archive-title">Yoga gains<br /><em>online popularity.</em></h2>
        <p>A record of Suresh extending personal yoga guidance beyond the studio during a defining time.</p>
        <div className="about-press-meta"><span>The Hindu</span><span>June 28, 2021</span></div>
      </header>
      <a className="about-press-paper" href="/assets/the-hindu-yoga-online-about-1138.webp" target="_blank" rel="noreferrer" aria-label="Open the complete The Hindu article" data-reveal data-reveal-delay="1">
        <img src="/assets/the-hindu-yoga-online-about-720.webp" srcSet="/assets/the-hindu-yoga-online-about-720.webp 720w, /assets/the-hindu-yoga-online-about-1138.webp 1138w" sizes="(max-width: 760px) 100vw, 60vw" width="1138" height="2238" alt="The Hindu newspaper article Yoga gains online popularity featuring Suresh" loading="lazy" decoding="async" />
      ...
      <main>
        <section className="about-suresh-hero instructor-profile instructor-profile-suresh">
          <div className="about-suresh-portrait instructor-portrait" data-reveal>
            <img src="/assets/suresh-profile-ceremony-960.webp" srcSet="/assets/suresh-profile-ceremony-640.webp 640w, /assets/suresh-profile-ceremony-960.webp 960w, /assets/suresh-profile-ceremony-1278.webp 1278w" sizes="(max-width: 760px) 100vw, 46vw" width="1278" height="1230" alt="Suresh being honoured at an International Yoga Day event" fetchPriority="high" />
        ...
        <section className="about-suresh-hero instructor-profile instructor-profile-gayatri">
          ...
          <div className="about-suresh-portrait instructor-portrait" data-reveal>
            <img src="/assets/gayatri-keerti-profile-ceremony-960.webp" srcSet="/assets/gayatri-keerti-profile-ceremony-640.webp 640w, /assets/gayatri-keerti-profile-ceremony-960.webp 960w, /assets/gayatri-keerti-profile-ceremony-1369.webp 1369w" sizes="(max-width: 760px) 100vw, 46vw" width="1369" height="1149" alt="Gayatri Keerti being honoured at an International Yoga Day event" loading="lazy" decoding="async" />
        ...
        <section className="practice-archive" aria-labelledby="practice-archive-title">
          ...
          <div className="practice-archive-gallery">
            <figure className="practice-photo practice-photo-wide" data-reveal style={{ "--reveal-index": 0 }}>
              <div className="practice-photo-frame"><img src="/assets/suresh-practice-seated-split-900.webp" alt="Suresh holding a seated split during his personal yoga practice" loading="lazy" decoding="async" /></div>
            ...
            <figure className="practice-photo practice-photo-tall" data-reveal style={{ "--reveal-index": 1 }}>
              <div className="practice-photo-frame"><img src="/assets/suresh-practice-arm-balance-700.webp" alt="Suresh demonstrating an advanced arm balance" loading="lazy" decoding="async" /></div>

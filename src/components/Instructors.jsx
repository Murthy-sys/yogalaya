...
export function Instructors() {
  return <section className="instructor" id="instructor">
    <div className="instructor-image" data-reveal><img src="/assets/yogalaya-instructors.jpg" alt="Yogalaya instructors seated together in meditation" loading="lazy" decoding="async" /></div>
